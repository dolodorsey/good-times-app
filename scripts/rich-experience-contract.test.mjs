...
test('Build My Night keeps the full visual planner and renders an editable source-backed route', () => {
  ...
  assert.match(builder, /CHOOSE THE ANCHOR/)
  assert.match(builder, /SET THE GUARDRAILS/)
  assert.match(builder, /EDIT THE ROUTE/)
  assert.match(builder, /Swap all three suggestions/)
