...
test('Frontend uses verified same-origin inventory and cannot bypass freshness', () => {
  ...
  assert.match(client, /Both verified event gateways failed; event inventory is hidden/)
