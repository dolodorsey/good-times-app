...
function AskPlanner({session,onBuild,busy,initialText=''}) {
  const[draft,patch]=useDraft(session,'ask'),[text,setText]=useState(initialText),[messages,setMessages]=useState([]),sending=useRef(false)
