...
function AskPlanner({session,onBuild,busy,initialText=''}) {
  ...
  return <UseBuild onBuild={onBuild} busy={busy}>{({submit,working,message})=>{
    ...
    return <section className="gt-ux-planner-panel gt-ux-ask" aria-label="Ask GOOD TIMES planner"><span className="gt-ux-eyebrow">ASK GOOD TIMES</span><h2>Tell us the idea.<br/><em>We’ll work out the plan.</em></h2><p>People, place, time, budget. Speak naturally.</p>
