...
/* ═══════════════════════════════════════════════════════
   ...
   3. Team logos deferred (keeping emojis)
...
// Cities/Teams (keeping emojis — logos deferred)
const Ri=[
  {id:"atlanta",name:"Atlanta",lat:33.749,lng:-84.388,teams:[{n:"Hawks",s:"NBA",e:"\u{1F3C0}",url:"https://www.nba.com/hawks/schedule"},{n:"Falcons",s:"NFL",e:"\u{1F3C8}",url:"https://www.atlantafalcons.com/schedule/"},{n:"Braves",s:"MLB",e:"\u26BE",url:"https://www.mlb.com/braves/schedule"},{n:"United",s:"MLS",e:"\u26BD",url:"https://www.atlutd.com/schedule"}]},
  {id:"houston",name:"Houston",lat:29.76,lng:-95.37,teams:[{n:"Rockets",s:"NBA",e:"\u{1F3C0}",url:"https://www.nba.com/rockets/schedule"},{n:"Texans",s:"NFL",e:"\u{1F3C8}",url:"https://www.houstontexans.com/schedule/"},{n:"Astros",s:"MLB",e:"\u26BE",url:"https://www.mlb.com/astros/schedule"},{n:"Dynamo",s:"MLS",e:"\u26BD",url:"https://www.houstondynamo.com/schedule"}]},
  {id:"los-angeles",name:"Los Angeles",lat:34.052,lng:-118.243,teams:[{n:"Lakers",s:"NBA",e:"\u{1F3C0}",url:"https://www.nba.com/lakers/schedule"},{n:"Rams",s:"NFL",e:"\u{1F3C8}",url:"https://www.therams.com/schedule/"},{n:"Dodgers",s:"MLB",e:"\u26BE",url:"https://www.mlb.com/dodgers/schedule"},{n:"LAFC",s:"MLS",e:"\u26BD",url:"https://www.lafc.com/schedule"}]},
  {id:"charlotte",name:"Charlotte",lat:35.227,lng:-80.843,teams:[{n:"Hornets",s:"NBA",e:"\u{1F3C0}",url:"https://www.nba.com/hornets/schedule"},{n:"Panthers",s:"NFL",e:"\u{1F3C8}",url:"https://www.panthers.com/schedule/"}]},
  {id:"washington",name:"Washington",lat:38.907,lng:-77.037,teams:[{n:"Wizards",s:"NBA",e:"\u{1F3C0}",url:"https://www.nba.com/wizards/schedule"},{n:"Commanders",s:"NFL",e:"\u{1F3C8}",url:"https://www.commanders.com/schedule/"},{n:"Nationals",s:"MLB",e:"\u26BE",url:"https://www.mlb.com/nationals/schedule"}]},
  {id:"miami",name:"Miami",lat:25.761,lng:-80.192,teams:[{n:"Heat",s:"NBA",e:"\u{1F3C0}",url:"https://www.nba.com/heat/schedule"},{n:"Dolphins",s:"NFL",e:"\u{1F3C8}",url:"https://www.miamidolphins.com/schedule/"},{n:"Inter Miami",s:"MLS",e:"\u26BD",url:"https://www.intermiamicf.com/schedule"}]},
  {id:"las-vegas",name:"Las Vegas",lat:36.17,lng:-115.14,teams:[{n:"Aces",s:"WNBA",e:"\u{1F3C0}",url:"https://aces.wnba.com/schedule/"},{n:"Raiders",s:"NFL",e:"\u{1F3C8}",url:"https://www.raiders.com/schedule/"},{n:"Golden Knights",s:"NHL",e:"\u{1F3D2}",url:"https://www.nhl.com/goldenknights/schedule"}]}
];
    ...
    <div style={{position:"fixed",inset:0,zIndex:50,background:C.overlay,display:"flex",alignItems:"flex-end"}} onClick={()=>setTeamSheet(null)}>
      <div onClick={e=>e.stopPropagation()} style={{width:"100%",maxWidth:430,margin:"0 auto",background:C.bgSheet,borderRadius:"20px 20px 0 0",padding:"24px 20px 40px"}}>
        ...
        <div style={{textAlign:"center",marginBottom:16}}>
          <div style={{fontSize:36,marginBottom:6}}>{teamSheet.e}</div>
          ...
          <div style={{padding:"0 16px",marginBottom:16}}>
            <div style={{...K,padding:0,overflow:"hidden",position:"relative",border:"1px solid rgba(107,255,184,0.4)"}}>
              ...
              <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                {(city.teams||[]).map(t=>(
                  <button key={t.n} onClick={()=>setTeamSheet(t)} style={{display:"flex",alignItems:"center",gap:6,padding:"8px 14px",borderRadius:12,background:"rgba(107,255,184,0.25)",border:"1px solid rgba(107,255,184,0.3)",cursor:"pointer",fontFamily:F.f,flex:"1 0 calc(50% - 4px)",minWidth:0}}>
