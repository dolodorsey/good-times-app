export const metadata = {
  title: "Good Times - Android Download",
  description: "Download the Good Times Android app directly.",
};
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: "32px" }}>
        ...
        <p style={{ color: "#FBBF24", fontSize: "1rem", margin: 0 }}>
          Your nightlife concierge across 8 cities.
        </p>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%", maxWidth: "320px" }}>
        ...
        <a
          href="https://dzlmtvodpyhetvektfuo.supabase.co/storage/v1/object/public/apks/good-times-release.apk"
          download="good-times-release.apk"
          style={{
            background: "#FBBF24",
            color: "#7C3AED",
            padding: "18px 32px",
      ...
      <p style={{ marginTop: "48px", color: "rgba(245,240,232,0.25)", fontSize: "0.75rem" }}>
        The Kollective Hospitality Group · thegoodtimesworldwide.com
      </p>
    </div>
  );
}
