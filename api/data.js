...
const EVENT_SELECT = [
  'event_key','source_table','source_id','city_key','title','event_date','event_time','venue_name',
  'raw_type','raw_category','ticket_url','image_url','organizer','display_priority','good_times_score',
  'category_key','subcategory_key','is_featured','is_curated','rank_order','refreshed_at',
].join(',')
const SHOW_SELECT = [
...
export default async function handler(request, response) {
  ...
  try {
    ...
    return sendJson(response, 200, {
      ok: true, connected: true, city, source: 'good-times-canonical-content', generated_at: generatedAt,
    ...
    return sendJson(response, 503, {
      ok: false, connected: false, city, source: 'good-times-canonical-content', generated_at: generatedAt,
